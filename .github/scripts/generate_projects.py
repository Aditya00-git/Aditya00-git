...
THEMES = {
    "dark": {
        "BG": "#0D1117", "PANEL": "#161B22", "PANEL_BAR": "#0D1117",
        "CYAN": "#C9D1D9", "VIOLET": "#8B949E", "VIOLET2": "#484F58",
        "EMERALD": "#C9D1D9", "TEXT": "#F0F6FC", "MUTED": "#8B949E",
        "DIM": "#484F58",
        "STROKE": "rgba(201,209,217,0.22)", "STROKE_HI": "rgba(201,209,217,0.45)",
        "STROKE_LO": "rgba(201,209,217,0.16)", "BARLINE": "rgba(255,255,255,0.08)",
        "RING_BG": "rgba(139,148,158,0.18)", "PILL_BG": "rgba(139,148,158,0.20)",
        "PILL_STROKE": "rgba(201,209,217,0.4)", "MONO_TX": "#0D1117",
    },
    "light": {
        "BG": "#F8FAFC", "PANEL": "#FFFFFF", "PANEL_BAR": "#F1F5F9",
        "CYAN": "#24292E", "VIOLET": "#57606A", "VIOLET2": "#57606A",
        "EMERALD": "#24292E", "TEXT": "#0F172A", "MUTED": "#475569",
        "DIM": "#94A3B8",
        "STROKE": "rgba(36,41,46,0.25)", "STROKE_HI": "rgba(36,41,46,0.45)",
        "STROKE_LO": "rgba(36,41,46,0.16)", "BARLINE": "rgba(0,0,0,0.08)",
        "RING_BG": "rgba(100,116,139,0.20)", "PILL_BG": "rgba(87,96,106,0.12)",
        "PILL_STROKE": "rgba(87,96,106,0.4)", "MONO_TX": "#FFFFFF",
    },
}
