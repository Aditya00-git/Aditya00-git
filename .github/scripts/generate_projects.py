...
THEMES = {
    "dark": {
        "BG": "#141110", "PANEL": "#1C1815", "PANEL_BAR": "#191512",
        "CYAN": "#2DD4BF", "VIOLET": "#E08A4E", "VIOLET2": "#C2601F",
        "EMERALD": "#2DD4BF", "TEXT": "#F5E9DD", "MUTED": "#B3A090",
        "DIM": "#6B5D4F",
        "STROKE": "rgba(224,138,78,0.28)", "STROKE_HI": "rgba(224,138,78,0.5)",
        "STROKE_LO": "rgba(224,138,78,0.20)", "BARLINE": "rgba(255,255,255,0.08)",
        "RING_BG": "rgba(179,160,144,0.18)", "PILL_BG": "rgba(224,138,78,0.20)",
        "PILL_STROKE": "rgba(224,138,78,0.45)", "MONO_TX": "#141110",
    },
    "light": {
        "BG": "#FAF8F5", "PANEL": "#FFFFFF", "PANEL_BAR": "#F3EEE7",
        "CYAN": "#0F7A6E", "VIOLET": "#B8501F", "VIOLET2": "#B8501F",
        "EMERALD": "#0F7A6E", "TEXT": "#241C15", "MUTED": "#6B5D4F",
        "DIM": "#9C8A78",
        "STROKE": "rgba(184,80,31,0.30)", "STROKE_HI": "rgba(184,80,31,0.5)",
        "STROKE_LO": "rgba(184,80,31,0.20)", "BARLINE": "rgba(0,0,0,0.08)",
        "RING_BG": "rgba(107,93,79,0.18)", "PILL_BG": "rgba(184,80,31,0.12)",
        "PILL_STROKE": "rgba(184,80,31,0.4)", "MONO_TX": "#FFFFFF",
    },
}
